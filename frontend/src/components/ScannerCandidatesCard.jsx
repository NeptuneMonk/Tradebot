...
export default function ScannerCandidatesCard({ candidates }) {
    ...
    <div className="control-card" data-testid="scanner-card">
      <div className="flex items-center justify-between mb-3">
        ...
        <span className="text-[10px] font-mono text-neutral-600">
          last 4h · {passing.length} passing
        </span>
      </div>

      {candidates.length === 0 ? (
        <div className="text-center py-6 text-[10px] uppercase tracking-[0.2em] text-neutral-600">
          building 4h watch window… (scanner kicks in once tokens accumulate)
        </div>
      ) : (
      ...
      <div className="flex items-center justify-between gap-2">
        <div className="min-w-0 flex-1">
          <div className="flex items-center gap-2">
            ...
            <span className="text-[10px] font-mono text-neutral-600">{fmtAge(c.age_s)} old</span>
          </div>
